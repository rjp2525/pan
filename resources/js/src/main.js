...
(function () {
    ...
    var detectImpressions = function () {
        ...
        elementsBeingImpressed.forEach(function (element) {
            ...
            var nameElements = document.querySelectorAll("[data-pan='".concat(name, "']"));
            if (nameElements.length > 1 && !sameNameElements.includes(name)) {
                console.warn("PAN: Multiple (".concat(nameElements.length, ") elements with the same name '").concat(name, "' found"));
